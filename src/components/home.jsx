...
function Home() {
  return (
  <div className="pl-5 lg:pl-0 h-auto lg:h-[85vh] lg:pt-20 lg:text-center lg:flex lg:items-start lg:justify-center">
    <Image/>
    ...
    <div className="card mt-24 flex gap-4 bg-white p-3 w-4/5 lg:w-auto lg:ml-0 ml-5 mb-2 lg:mb-0 lg:p-4 lg:py-5 rounded-lg">
